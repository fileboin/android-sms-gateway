package com.smspeer.app.modules.localserver
...
import com.smspeer.app.extensions.configure
...
import com.smspeer.app.modules.localserver.auth.JwtService
import com.smspeer.app.modules.localserver.auth.requireScope
import com.smspeer.app.modules.localserver.domain.Device
import com.smspeer.app.modules.localserver.routes.AuthRoutes
import com.smspeer.app.modules.localserver.routes.DocsRoutes
import com.smspeer.app.modules.localserver.routes.InboxRoutes
import com.smspeer.app.modules.localserver.routes.LogsRoutes
import com.smspeer.app.modules.localserver.routes.MessagesRoutes
import com.smspeer.app.modules.localserver.routes.WebhooksRoutes
    ...
    private val server by lazy {
        embeddedServer(
            ...
            install(ContentNegotiation) {
                gson {
                    if (com.smspeer.app.BuildConfig.DEBUG) {
                        setPrettyPrinting()
                    }
                    configure()
                }
            ...
            routing {
                ...
                authenticate("auth-basic", "auth-jwt") {
                    ...
                    route("/settings") {
                        com.smspeer.app.modules.localserver.routes.SettingsRoutes(get())
                            .register(this)
                    }
                    route("/docs") {
