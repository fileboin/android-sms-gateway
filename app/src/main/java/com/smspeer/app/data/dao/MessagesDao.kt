package com.smspeer.app.data.dao
...
import com.smspeer.app.data.entities.MessagesStats
import com.smspeer.app.data.entities.MessagesTotals
...
interface MessagesDao {
    ...
    fun _insertRecipientStatesByMessage(
        messageId: String,
        state: com.smspeer.app.domain.ProcessingState
    )
    ...
    fun _updateMessageState(id: String, state: com.smspeer.app.domain.ProcessingState)

    fun updateMessageState(id: String, state: com.smspeer.app.domain.ProcessingState) {
    ...
    fun setMessageProcessed(id: String) {
        ...
        _insertMessageState(
            MessageState(
                id,
                com.smspeer.app.domain.ProcessingState.Processed,
                System.currentTimeMillis()
            )
        )
    }
