package com.smspeer.app.ui.adapters
...
import com.smspeer.app.databinding.ItemWebhookBinding
import com.smspeer.app.modules.webhooks.domain.WebHookDTO
        ...
        fun bind(webhook: WebHookDTO) {
            binding.apply {
                ...
                sourceText.text = when (webhook.source) {
                    com.smspeer.app.domain.EntitySource.Local -> binding.root.context.getString(
                        R.string.local
                    )

                    com.smspeer.app.domain.EntitySource.Gateway,
                    com.smspeer.app.domain.EntitySource.Cloud -> binding.root.context.getString(
                        R.string.cloud
                    )
                }
                sourceIcon.setImageResource(
                    when (webhook.source) {
                        com.smspeer.app.domain.EntitySource.Local -> R.drawable.ic_local_server
                        com.smspeer.app.domain.EntitySource.Cloud,
                        com.smspeer.app.domain.EntitySource.Gateway -> R.drawable.ic_cloud_server
                    }
                )
            }
        }
